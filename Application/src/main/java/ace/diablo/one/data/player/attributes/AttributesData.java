package ace.diablo.one.data.player.attributes;

import ace.diablo.one.Utils;
import ace.diablo.one.core.errors.IllegalPlayerDataException;
import ace.diablo.one.core.events.AttributesInitiatedEvent;
import ace.diablo.one.core.events.DatabaseInitiatedEvent;
