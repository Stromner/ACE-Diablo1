package ace.diablo.one.ui.components.panels.sub;

import ace.diablo.one.data.player.attributes.IAttributesData;
import ace.diablo.one.ui.components.partial.ADataPanel;
import ace.diablo.one.ui.components.partial.spinner.SpinnerDataPanel;
import ace.diablo.one.ui.components.partial.text.field.TextReadOnlyDataPanel;
